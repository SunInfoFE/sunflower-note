...
* [接口文档](#接口文档)
    1. [注册](#注册)
    2. [登录](#登录)
    3. [本周周报（获取所有本周周报/新增/修改/删除）](#本周周报（获取所有本周周报/新增/修改/删除）)
    4. [我的周报（获取周报（条件获取：年、第几周、是否已提交或所有）/获取周报详情/删除）](#我的周报（获取周报（条件获取：年、第几周、是否已提交或所有）/获取周报详情/删除）)
    5. [已提交的周报](#已提交的周报)
    6. [小组周报](#小组周报)
    7. [小组管理（获取所有小组/添加小组/编辑小组/删除小组（空小组可删除）/搜索用户）](#小组管理（获取所有小组/添加小组/编辑小组/删除小组（空小组可删除）/搜索用户）)
